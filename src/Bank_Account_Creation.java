...
public class Bank_Account_Creation implements ActionListener
{
	JFrame fbac;
	...
	Bank_Account_Creation()
	{
		...
		branch = new JLabel("Select Branch");branch.setBounds(1000,70,100,30);fbac.add(branch);
		 ...
		 * password
		 */
		password = new JLabel("Enter Password");password.setBounds(530,420,100,30);fbac.add(password);
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				try
				{
					...
					String cmtquery = "insert into clientmaintable value(?,?,?,?,?,?,?,CURRENT_TIMESTAMP)";
					String catquery = "insert into clientaddresstable value(?,?,?,?,?,?,?,?,?,?)";
					String cntquery = "insert into clientnomineetable value(?,?,?,?,?,?,?)";
					...
					pst1.setLong(1,laccno);
					pst1.setString(2,sname);
					pst1.setLong(3,laadno);
					pst1.setString(4,sgender);
					pst1.setString(5,sDOB);
					pst1.setString(6,smail);
					pst1.setString(7,scpassword);
					//ClientAddressTable Data
					pst2.setLong(1,laccno);
					pst2.setString(2,scountry);
					pst2.setString(3,shouseno);
					pst2.setInt(4,ipincode);
					pst2.setString(5,sstreet);
					pst2.setString(6,sarea_loc);
					pst2.setString(7,svillage);
					pst2.setString(8,slandmark);
					pst2.setString(9,sdistrict);
					pst2.setString(10,sstate);
					
					//ClientAddressTable Data
					pst3.setLong(1,laccno);
					pst3.setString(2,snoname);
					pst3.setLong(3,lnomobile);
					pst3.setLong(4,lnoaadno);
					pst3.setString(5,sprofession);
					pst3.setString(6,snocountry);
					pst3.setString(7,snoarea_loc);
					
					//Bank Table Data
					pst4.setLong(1,laccno);
					pst4.setDouble(2,0);
					pst4.setString(3,ssbranch);
					pst4.setString(4,(String)branches.getSelectedItem());
